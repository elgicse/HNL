...
//#include "/afs/cern.ch/user/e/egraveri/pythia8186/include/Pythia8/Pythia.h"
#include "/home/elena/pythia8180/include/Pythia8/Pythia.h"
#include "TPythia8.h"
#include "TRandom3.h"
...
void pythia8_Beauty(Int_t nev  = 10000, Int_t ndeb = 1, Int_t seed=2210)
{
...
// Particle loop
	 ...
	 if((charm%1000)>510 && (charm%1000)<560){
   ...
   char fname[50];
   sprintf(fname, "out/BeautyFixTarget_%d.root", seed);
