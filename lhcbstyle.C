...
// G.Barrand : cout replaced with printf (cout not known from Panoramix !).
 printf("executing lhcbStyle.C:\n");
 printf("                      \n");
 printf("                      \n");
 printf("                         $      $   $   $$$   $    \n");
 printf("                         $      $   $  $      $    \n");
 ...
 printf("                         $$$$$  $   $   $$$   $$$  \n");
 printf(" \n");
 printf("                           LHCb ROOT style file \n");
 printf(" \n");
 printf("     Problems, suggestions, contributions to Thomas.Schietinger@cern.ch\n"); 
 printf(" \n");
